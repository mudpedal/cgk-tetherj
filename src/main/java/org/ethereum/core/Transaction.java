...
public class Transaction {
    ...
    public long transactionCost() {
        ...
        return GasCost.TRANSACTION + zeroVals * GasCost.TX_ZERO_DATA
    ...
    public String toString() {
        ...
        return "TransactionData [" + "hash=" + ByteUtil.toHexString(hash) + "  nonce="
                + ByteUtil.toHexString(nonce) + ", gasPrice=" + ByteUtil.toHexString(gasPrice)
                + ", gas=" + ByteUtil.toHexString(gasLimit) + ", receiveAddress="
                + ByteUtil.toHexString(receiveAddress) + ", value=" + ByteUtil.toHexString(value)
    ...
    public byte[] getEncoded() {
        ...
        this.rlpEncoded = RLP.encodeList(nonce, gasPrice, gasLimit, receiveAddress, value, data, v,
                r, s);
